...
describe('parameter workflow tools', () => {
  it('lists workflows', async () => {
    ...
    await listParameterWorkflows.handler(
      ...
      response as unknown as Parameters<typeof listParameterWorkflows.handler>[1],
  ...
  it('gets a workflow by id', async () => {
    ...
    await getParameterWorkflow.handler(
      {params: {id: 'jd-h5st'}} as Parameters<typeof getParameterWorkflow.handler>[0],
  ...
  it('recommends a workflow from keyword', async () => {
    ...
    await recommendParameterWorkflow.handler(
      {params: {query: 'h5st'}} as Parameters<typeof recommendParameterWorkflow.handler>[0],
      response as unknown as Parameters<typeof recommendParameterWorkflow.handler>[1],
